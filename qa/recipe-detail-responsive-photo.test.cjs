...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoStylesUrl = 'app-v1.css?v=20260822-launch-splash-v46';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v46-launch-splash/, 'le worker doit déclarer le cache courant');
