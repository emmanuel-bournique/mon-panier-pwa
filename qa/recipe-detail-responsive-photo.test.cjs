...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260822-discover-single-green-bubble-v45';
  const photoStylesUrl = 'app-v1.css?v=20260822-discover-single-green-bubble-v45';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v45-discover-single-green-bubble/, 'le worker doit déclarer le cache courant');
