...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoStylesUrl = 'app-v1.css?v=20260820-recipe-detail-mobile-geometry-v27';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v27-recipe-detail-mobile-geometry/, 'le worker doit déclarer le cache courant');
