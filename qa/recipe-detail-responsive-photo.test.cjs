...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260817-detail-standalone-safe-area-v16';
  const photoStylesUrl = 'app-v1.css?v=20260817-detail-standalone-safe-area-v16';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v16-detail-standalone-safe-area/, 'le worker doit abandonner le cache antérieur');
