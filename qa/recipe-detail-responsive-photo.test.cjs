...
test('le correctif de cadrage photo reçoit une révision PWA dédiée', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260817-ios-safe-area-meta-v1';
  const photoStylesUrl = 'app-v1.css?v=20260817-ios-safe-area-meta-v1';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v12-ios-safe-area-meta/, 'le worker doit abandonner le cache antérieur');
