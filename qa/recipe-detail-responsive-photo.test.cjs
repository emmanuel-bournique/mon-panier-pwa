...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoStylesUrl = 'app-v1.css?v=20260820-safe-area-top-v25';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v25-safe-area-top/, 'le worker doit déclarer le cache courant');
