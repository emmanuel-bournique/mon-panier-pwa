...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260818-recipe-detail-ingredient-media-v21';
  const photoStylesUrl = 'app-v1.css?v=20260818-recipe-detail-ingredient-media-v21';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v21-recipe-detail-ingredient-media/, 'le worker doit déclarer le cache courant');
