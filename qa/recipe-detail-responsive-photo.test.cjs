...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260821-discover-glass-nav-v38-mobile-rail-lift';
  const photoStylesUrl = 'app-v1.css?v=20260821-discover-glass-nav-v38-mobile-rail-lift';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v38-discover-glass-nav-mobile-rail-lift/, 'le worker doit déclarer le cache courant');
