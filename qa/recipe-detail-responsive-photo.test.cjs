...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260820-discover-glass-nav-v34-iphone14pro-spring';
  const photoStylesUrl = 'app-v1.css?v=20260820-discover-glass-nav-v34-iphone14pro-spring';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v34-discover-glass-nav-iphone14pro-spring/, 'le worker doit déclarer le cache courant');
