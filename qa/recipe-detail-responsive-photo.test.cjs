...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoStylesUrl = 'app-v1.css?v=20260820-recipe-detail-bottom-surface-v29';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v29-recipe-detail-bottom-surface/, 'le worker doit déclarer le cache courant');
