...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260818-discover-favorite-heart-upper-left-v19';
  const photoStylesUrl = 'app-v1.css?v=20260818-discover-favorite-heart-upper-left-v19';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v19-discover-favorite-heart-upper-left/, 'le worker doit abandonner le cache antérieur');
