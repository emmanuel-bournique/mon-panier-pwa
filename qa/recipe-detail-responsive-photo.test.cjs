...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260821-discover-glass-nav-v40-compact-safe-area';
  const photoStylesUrl = 'app-v1.css?v=20260821-discover-glass-nav-v40-compact-safe-area';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v40-discover-glass-nav-compact-safe-area/, 'le worker doit déclarer le cache courant');
