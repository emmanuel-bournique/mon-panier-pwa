...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoStylesUrl = 'app-v1.css?v=20260820-github-web-v3';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-github-web-v3/, 'le worker doit déclarer le cache courant');
