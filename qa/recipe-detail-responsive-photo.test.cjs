...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260822-discover-single-green-bubble-v42';
  const photoStylesUrl = 'app-v1.css?v=20260822-discover-single-green-bubble-v42';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v42-discover-single-green-bubble/, 'le worker doit déclarer le cache courant');
