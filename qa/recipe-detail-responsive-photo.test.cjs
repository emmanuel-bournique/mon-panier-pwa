...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoStylesUrl = 'app-v1.css?v=20260820-recipe-detail-shared-nav-v28';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v28-recipe-detail-shared-nav/, 'le worker doit déclarer le cache courant');
