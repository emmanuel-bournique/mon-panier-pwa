...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260820-discover-glass-nav-v32';
  const photoStylesUrl = 'app-v1.css?v=20260820-discover-glass-nav-v32';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v32-discover-glass-nav/, 'le worker doit déclarer le cache courant');
