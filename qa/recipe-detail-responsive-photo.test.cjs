...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoStylesUrl = 'app-v1.css?v=20260822-navigation-glass-v47';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v47-navigation-glass/, 'le worker doit déclarer le cache courant');
