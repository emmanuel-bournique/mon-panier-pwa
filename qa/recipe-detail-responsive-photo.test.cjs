...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260817-courses-create-v14';
  const photoStylesUrl = 'app-v1.css?v=20260817-courses-create-v14';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v14-courses-create/, 'le worker doit abandonner le cache antérieur');
