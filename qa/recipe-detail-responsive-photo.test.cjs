...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260821-discover-glass-nav-v37-bubble-rail-lift';
  const photoStylesUrl = 'app-v1.css?v=20260821-discover-glass-nav-v37-bubble-rail-lift';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v37-discover-glass-nav-bubble-rail-lift/, 'le worker doit déclarer le cache courant');
