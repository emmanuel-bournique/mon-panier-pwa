...
test('le correctif de cadrage photo reçoit une révision PWA dédiée', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260817-worker-activation-v1';
  const photoStylesUrl = 'app-v1.css?v=20260817-worker-activation-v1';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v13-worker-activation/, 'le worker doit abandonner le cache antérieur');
