...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260822-navigation-glass-v50';
  const photoStylesUrl = 'app-v1.css?v=20260822-navigation-glass-v50';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v50-navigation-glass/, 'le worker doit déclarer le cache courant');
