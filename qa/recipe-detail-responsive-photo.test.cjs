...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260817-detail-empty-cart-v15';
  const photoStylesUrl = 'app-v1.css?v=20260817-detail-empty-cart-v15';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v15-detail-empty-cart/, 'le worker doit abandonner le cache antérieur');
