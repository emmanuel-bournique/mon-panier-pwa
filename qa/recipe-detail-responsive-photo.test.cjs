...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260818-discover-favorite-heart-thumbnail-upper-left-v20';
  const photoStylesUrl = 'app-v1.css?v=20260818-discover-favorite-heart-thumbnail-upper-left-v20';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v20-discover-favorite-heart-thumbnail-upper-left/, 'le worker doit déclarer le cache courant');
