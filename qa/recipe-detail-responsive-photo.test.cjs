...
test('le correctif de cadrage photo reste dans une révision PWA active', () => {
  ...
  const photoRuntimeUrl = 'app-v1.js?v=20260820-discover-glass-nav-v33-bubble-fix';
  const photoStylesUrl = 'app-v1.css?v=20260820-discover-glass-nav-v33-bubble-fix';
  ...
  assert.match(serviceWorker, /mon-panier-runtime-v33-discover-glass-nav-bubble-fix/, 'le worker doit déclarer le cache courant');
